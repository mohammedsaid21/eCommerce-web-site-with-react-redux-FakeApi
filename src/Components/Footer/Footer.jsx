      ...
      <div className="container">
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          ...
          <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
            <a href="https://www.facebook.com/profile.php?id=100011819852336" target='_blank' className="text-gray-500 hover:text-gray-900 hover:">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path fillRule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clipRule="evenodd"></path></svg>
            </a>
            <a href="https://github.com/mohammedsaid21?tab=overview&from=2022-04-01&to=2022-04-03" className="text-gray-500 hover:text-gray-900">
            ...
            <a href="/" className="text-gray-500 hover:text-gray-900 ">
              <img className='w-6 text-center' src={require('../../assets/images/LI-In-Bug.png')} alt='' />
            </a>
            <a href="/" className="text-gray-500 hover:text-gray-900 hover:">
